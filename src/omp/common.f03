module common_mod
  ...
  character(len=100), parameter ::  VERSION="GGADT (General Geometry Anomalous Diffraction Theory) v0.9.1"
  ...
  contains
    ...
    subroutine set_parameter_values()
      ...
      call define_option_real(opts,"grain-axis-x",1.0,&
        description="For ELLIPSOID grains: x-axis length")
      call define_option_real(opts,"grain-axis-y",1.0,&
        description="For ELLIPSOID grains: y-axis length")
      call define_option_real(opts,"grain-axis-z",1.0,&
