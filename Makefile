...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(top_srcdir)/scripts/installation_vars.py.in \
	$(srcdir)/default.params.in COPYING compile config.guess \
...
CONFIG_CLEAN_FILES = scripts/installation_vars.py default.params
...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"ggadt\" -DPACKAGE_TARNAME=\"ggadt\" -DPACKAGE_VERSION=\"1.1.2\" -DPACKAGE_STRING=\"ggadt\ 1.1.2\" -DPACKAGE_BUGREPORT=\"jah5@princeton.edu\" -DPACKAGE_URL=\"\" -DPACKAGE=\"ggadt\" -DVERSION=\"1.1.2\" -DCONFIG_PREFIX=\"/usr/local\" -DHAVE_LIBM=1 -DHAVE_OMP_H=1
DEPDIR = .deps
DOUBLE_UNCOMMENT = 
ECHO_C = \c
ECHO_N = 
...
$(am__aclocal_m4_deps):
scripts/installation_vars.py: $(top_builddir)/config.status $(top_srcdir)/scripts/installation_vars.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
default.params: $(top_builddir)/config.status $(srcdir)/default.params.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
