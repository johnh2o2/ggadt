...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(top_srcdir)/scripts/installation_vars.py.in COPYING compile \
...
CONFIG_CLEAN_FILES = scripts/installation_vars.py
...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"ggadt\" -DPACKAGE_TARNAME=\"ggadt\" -DPACKAGE_VERSION=\"0.9.8\" -DPACKAGE_STRING=\"ggadt\ 0.9.8\" -DPACKAGE_BUGREPORT=\"jah5@princeton.edu\" -DPACKAGE_URL=\"\" -DPACKAGE=\"ggadt\" -DVERSION=\"0.9.8\" -DCONFIG_PREFIX=\"/usr/local\" -DHAVE_LIBM=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
top_builddir = .
top_srcdir = .
EXTRA_DIST = configure scripts src doc data
SUBDIRS = src doc 
all: all-recursive
