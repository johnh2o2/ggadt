...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"ggadt\" -DPACKAGE_TARNAME=\"ggadt\" -DPACKAGE_VERSION=\"0.18\" -DPACKAGE_STRING=\"ggadt\ 0.18\" -DPACKAGE_BUGREPORT=\"jah5@princeton.edu\" -DPACKAGE_URL=\"\" -DPACKAGE=\"ggadt\" -DVERSION=\"0.18\" -DCONFIG_PREFIX=\"/usr/local\" -DHAVE_LIBM=1 -DHAVE_LIBFFTW3=1 -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_FFTW3_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STDIO_H=1 -DHAVE_OMP_H=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
